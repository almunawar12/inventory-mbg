<div>
    <div class="space-y-2">
        <!-- Filter Section -->
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-sky-200 bg-card p-4 rounded-lg border border-border shadow-sm">
        <div class="">
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <!-- Total Sales -->
        <div class="rounded-xl border bg-green-200 bg-card text-card-foreground shadow-sm">
        ...
        <!-- Gross Profit -->
        <div class="rounded-xl border bg-yellow-200 bg-card text-card-foreground shadow-sm">
            <div class="p-4 flex flex-row items-center justify-between space-y-0 pb-2">
        ...
        <!-- Net Cash Flow -->
        <div class="rounded-xl border bg-purple-200 bg-card text-card-foreground shadow-sm">
            <div class="p-4 flex flex-row items-center justify-between space-y-0 pb-2">
         ...
         <!-- Low Stock Alert -->
         <div class="rounded-xl border bg-red-300 bg-card text-card-foreground shadow-sm">
            <div class="p-4 flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <div class="p-4 pt-0">
                ...
                <p class="text-xs text-muted-foreground mt-1">
                    From <b>{{ count($stockProducts) }} Products</b>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <!-- Cash Flow -->
         <div class="col-span-1 lg:col-span-1 rounded-xl border bg-card text-card-foreground shadow-sm break-inside-avoid">
            <div class="p-4 flex flex-col space-y-1.5 border-b">
                <h3 class="font-semibold leading-none tracking-tight">Low Stock Product</h3>
                <p class="text-xs text-muted-foreground">Low Stock Product overview.</p>
            </div>
            <div class="p-0">
                        ...
                        <tbody class="[&_tr:last-child]:border-0 bg-transparent">
                             @forelse($lowStockProducts as $product)
                                <tr class="border-b transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted">
                                    ...
                                    <td class="px-4 py-2 align-middle text-right font-medium text-emerald-600"> {{ $product['quantity'] }}</td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="2" class="p-4 text-center text-muted-foreground">No Data.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
